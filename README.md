...
Associations:
> [MongoDB One-to-One relationship users with Mongoose examples](https://www.bezkoder.com/mongoose-one-to-one-relationship-example/)

> [MongoDB One-to-Many Relationship users with Mongoose examples](https://www.bezkoder.com/mongoose-one-to-many-relationship/)
